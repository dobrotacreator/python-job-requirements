...
13. ## **_Назови десять встроенных функций._**
   ...
   - len(x); 
   - iter(x)
14. ## **_Какие принципы ООП ты знаешь в_** **_Python_****_?_**
...
9. ## **_Как работает механизм аллоцирования памяти в питоне?_**
    ![](file:///tmp/lu6535hte0.tmp/lu6535i6qf_tmp_43f2fe2fd8930c03.png)
...
7. **_Constraints_** **_в базах данных?_**
...
12. **_Какие уровни нормализации используются в_** **_PostgreSQL и какие в_** **_MySQL?_**
...
16. **_В каком формате данные хранятся в_** **_MongoDB_** **_и_** **_Redis_****_?_**
